...
.event-logos a img[alt="FAO FRA"] {
    background-color: #3d6036;
}

.event-logos a img:hover {
    opacity: 0.7;
...
<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <a href="events.php"class="active"> <!-- Events page -->
...
<div class= "inner">
 ...
 <h1>Here are some featured events supporting SDG 15:</h1>

<div class="event-logos">
  <a href="https://www.trilliontreecampaign.org/en" target="_blank">
    <img src="https://www.trilliontreecampaign.org/tenants/ttc/logo.png" alt="Trillion Tree Campaign">
  </a>

  <a href="https://www.fao.org/events/detail/" target="_blank">
    <img src="https://www.fao.org/fileadmin/templates/faoweb/images/FAO-logo-w.png" alt="FAO FRA">
  </a>

  <a href="https://www.bonnchallenge.org/make-a-pledge" target="_blank">
    <img src="https://www.bonnchallenge.org/themes/custom/bonnchallenge_m3_theme/logo.svg" alt="The Bonn Challenge">
  </a>

  <a href="https://wildlifeday.org/en/events-list" target="_blank">
    <img src="https://wildlifeday.org/sites/default/files/2022-11/logo/wwd_e.gif" alt="World Wildlife Day">
  </a>
</div>
